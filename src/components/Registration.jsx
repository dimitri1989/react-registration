...
function Registration (){
    ...
    const [date,setDate] = useState({email:"",username:"",password:""})
    function handleFormSubmit(event) {
        ...
        date.email.length ? form[0].className=colors.success : window.alert("შეავსე მეილის ფორმა")
        date.username.length ? form[1].className=colors.success : window.alert("შეავსე username ფორმა")
        date.password.length ? form[2].className=colors.success : window.alert("შეავსე password ფორმა")
      }
    ...
    return(
        <div className="w-50 mt-5">
            ...
            <div className="mb-3">
                    ...
                    <input type="text" className="form-control " value={date.email} onChange={(e) =>{handelchange(e,'email')}}  />
